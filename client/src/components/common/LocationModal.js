            ...
            {activeTab === 'search' ? (
              <>
                ...
                <div className="relative mb-4">
                  ...
                  {searchLoading && (
                    <Loader2 className="absolute right-3 top-1/2 -translate-y-1/2 h-5 w-5 text-green-500 animate-spin" />
                  )}
                </div>
              ...
              <form onSubmit={handleManualSubmit} className="space-y-4">
                ...
                <button 
                  type="submit" 
                  className="w-full bg-green-500 text-white py-3 rounded-lg hover:bg-green-600 transition-colors font-medium mt-2 disabled:opacity-50 disabled:cursor-not-allowed" 
                  disabled={loading}
                >
                  {loading ? (
